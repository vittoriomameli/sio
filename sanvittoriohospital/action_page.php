<!DOCTYPE html>
<html>
<title>ESITO - SANVITTORIOHOSPITAL</title>
<meta charset="UTF-8">
...
<body>
  ...
  <header class="w3-container w3-red w3-center" style="padding:128px 16px">
    <h1 class="w3-margin w3-jumbo">RICHIESTA CONFERMATA!</h1>
    <p class="w3-xlarge">SANVITTORIOHOSPITAL.NET</p>
    <button onclick="window.location.href='index.php'" class="w3-button w3-black w3-padding-large w3-large w3-margin-top">TORNA AL SITO</button>
  </header>
